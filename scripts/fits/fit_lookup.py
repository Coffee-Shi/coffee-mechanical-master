...
DATA_DIR = SKILL_ROOT / "references" / "limits-and-fits" / "data"
...
def make_result(diameter_mm: float, family: dict[str, Any], fit: str) -> dict[str, Any] | None:
    ...
    return {
        ...
        "knowledge_sources": [
            "references/limits-and-fits/preferred-fits.md",
            "references/limits-and-fits/machining-and-cost.md",
            "references/limits-and-fits/data/standard-tolerances.json",
        ],
    }
